...
<svelte:head>
  ...
  <meta
    name="description"
    content="Explora los productos con la etiqueta {page.params
      .tag} en Mami Crafts. Encuentra artículos únicos y hechos a mano que se adaptan a tus necesidades."
  />
</svelte:head>

<h1 class="mb-3 p-3 text-2xl font-bold">Tag: {page.params.tag}</h1>
