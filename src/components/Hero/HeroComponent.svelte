...
<div class="flex w-full justify-center">
  <div
    class="card border-base-300 shadow-base-300/50 mx-3 grid min-h-32 flex-grow translate-y-[-50%] grid-cols-2 gap-[1px] border bg-white shadow-xl md:mx-16 md:grid-cols-4"
  >
